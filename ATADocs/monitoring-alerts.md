...
### <a name="ata-center-running-out-of-disk-space"></a>Espace disque du centre ATA insuffisant
...
### <a name="failure-sending-mails"></a>Échec de l’envoi des e-mails
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="ata-center-overloaded"></a>Centre ATA surchargé
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="ata-center-certificate-is-about-to-expire"></a>Le certificat du centre ATA est sur le point d’expirer
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="read-only-user-password-is-about-to-expire"></a>Le mot de passe de l’utilisateur en lecture seule est sur le point d’expirer
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="ata-gateway-certificate-about-to-expire"></a>Le certificat de la passerelle ATA est sur le point d’expirer
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="ata-gateway-certificate-expired"></a>Le certificat de la passerelle ATA a expiré
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="allsome-of-the-capture-network-adapters-on-an-ata-gateway-are-not-available"></a>Tout ou partie des cartes réseau de capture sur une passerelle ATA ne sont pas disponibles
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="some-domain-controllers-are-unreachable-by-a-ata-gateway"></a>Certains contrôleurs de domaine ne sont pas accessibles par une passerelle ATA
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="all-domain-controllers-are-unreachable-by-a-ata-gateway"></a>Aucun contrôleur de domaine n’est accessible par une passerelle ATA
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="ata-gateway-stopped-communicating"></a>La passerelle ATA a cessé de communiquer
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="ata-gateway-version-outdated"></a>Version de la passerelle ATA obsolète
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="ata-gateway-service-failed-to-start"></a>Échec du démarrage du service de passerelle ATA
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
...
### <a name="lightweight-ata-gateway-reached-a-memory-resource-limit"></a>La passerelle légère ATA a atteint la limite des ressources mémoire
|Alerte|Description|Résolution|Gravité|
|----|----|----|----|
